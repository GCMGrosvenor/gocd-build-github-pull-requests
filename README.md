...
## Behavior
- First run of the new pipeline will be off of 'master' branch unless another default branch is specified in the configuration. This creates base PR-Revision map. It also serves as sanity check for newly created pipeline.
...
- PR details (id, author etc.) will be available as environment variable for tasks to consume.
